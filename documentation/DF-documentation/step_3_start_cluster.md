...
* Distributed-FIJI will create the APP_NAMESpotFleetRequestId.json file, which will allow you to [start your progress monitor](step_4_monitor.md).
...
* Distributed-FIJI will create the log groups (if they don't already exist) for your log streams to go in.
* Distributed-FIJI will ask AWS to place Docker containers onto the instances in your spot fleet.
