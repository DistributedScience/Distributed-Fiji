...
Distributed-Fiji is run by a series of three commands, only one of which incurs costs:
...
It initiates your spot fleet request, the major cost of running Distributed-Fiji, exact pricing of which depends on the number of machines, type of machines, and duration of use. 
